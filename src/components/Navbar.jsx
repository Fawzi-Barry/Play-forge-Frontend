    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        navigate("/search-results", {
          state: { query: searchQuery, results: response.data.posts },
        });
      } else {
      ...
      <nav className="p-4 bg-geda">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {location.pathname === "/" && (
            <div className="flex-auto mx-3 relative hidden md:block">
              <form onSubmit={handleSearch}>
                ...
                <button
                  type="submit"
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 mr-1 text-white h-6 w-6"
                >
                  <svg
          ...
          <div className="flex items-center">
            <button
              className="text-white block md:hidden ml-5"
                      ...
                      <ul>
                        <li>
                          <a className="block px-4 py-2 text-white hover:bg-gray-700">
                            <FontAwesomeIcon icon={faUser} className="mr-6" />
                            <Link to={`/profile/profile_page`}>Profile</Link>
                          </a>
                        </li>
