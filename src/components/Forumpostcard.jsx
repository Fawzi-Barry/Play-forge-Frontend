      ...
      <div className="">
        <div className="flex items-center justify-between p-6">
          <div className="flex items-center space-x-3">
            <img
              ...
              src={forumInfo.postedUser.profilePicture}
              alt={forumInfo.postedFullname}
            />

            <div>
              <p className="text-lg font-semibold">
                {forumInfo.postedFullname}
              </p>
        ...
        <div className="flex items-center justify-between text-sm text-gray-300 p-6">
          <div className="flex space-x-4">
            <button
              onClick={(event) => handleClick(event, onComment)}
            ...
            <button
              onClick={(event) => handleClick(event, onLike)}
              className="flex items-center hover:text-white"
            >
            ...
            <button
              onClick={(event) => handleClick(event, onDislike)}
              className="flex items-center hover:text-white"
            >
