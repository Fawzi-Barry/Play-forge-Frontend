...
const Homepage = () => {
  ...
  const handleImageUpload = (file) => {
    if (file && file.progress == 100) {
      ...
      setPostPicture(file.allEntries[0].cdnUrl);
    }
  };
                ...
                {!isExpanded && (
                  <div className="flex space-x-4">
                    ...
                    <button
                      ...
                      className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-md flex items-center transition duration-300"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-4">
                      <button
                        ...
                        className="border border-gray-600 text-gray-300 hover:bg-gray-700 font-bold py-2 px-4 rounded-md transition duration-300"
                      >
                        Cancel
                      </button>
                      <button
